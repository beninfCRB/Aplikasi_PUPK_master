...
--
-- Host: localhost:3306
-- Waktu pembuatan: 23 Jul 2021 pada 01.51
-- Versi server: 5.7.24
-- Versi PHP: 7.4.20
...
INSERT INTO `ip` (`id_ip`, `nama_ip`) VALUES
(2, '10.20.30.22');
...
INSERT INTO `semester` (`id_smt`, `nama_smt`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
INSERT INTO `token` (`id_token`, `nama_token`, `tanggal`, `mulai`, `akhir`, `status`) VALUES
(8, '111', '2021-07-18', '18:00', '18:26', 'nonaktif'),
(9, '222', '2021-07-18', '18:26', '18:28', 'nonaktif'),
(10, '333', '2021-07-18', '18:28', '18:30', 'nonaktif'),
(11, '12345', '2021-07-23', '07:00', '23:59', 'aktif');
...
(2, 'beni', '$2y$10$xLMXEgHeONS8UW1NLEsQyODtucCaFF/ENZTmRObpo6pXcB4AlAHyG', 'Beni Nurfauzi', 'beni.jpg', 1);
...
--
ALTER TABLE `semester`
  MODIFY `id_smt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
