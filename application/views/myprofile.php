    ...
    <main>
        <div class="container-fluid">
            ...
            <?php if ($this->session->flashdata()) : ?>
                <div class="alert <?= $this->session->flashdata('flash') == 'Gagal' ? 'alert-danger' : 'alert-success'  ?> alert-dismissible fade show mt-3" role="alert">
                    Update Data User <strong> <?= $this->session->flashdata('flash'); ?> </strong>.
                                    ...
                                    <div class="col-md-8">
                                        <form enctype="multipart/form-data" class="form-group" action="<?= base_url('myprofile'); ?>" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="password" name="password-old" type="password" class="form-control" placeholder="Masukan Password Lama"></input>
                                                    <?php if (form_error('password-old')) : ?>
                                                        <div class="alert alert-danger alert-dismissible fade show mt-1" role="alert" style="height: 50px;">
                                                            <?= form_error('password-old'); ?>
                                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="password" name="password" type="password" class="form-control" placeholder="Masukan Password Baru"></input>
