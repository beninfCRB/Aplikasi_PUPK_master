                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-primary" type="button" id="btn_token" data-url="<?= base_url(); ?>">Cek Token</button>
                                            </div>
                                            <div class="ml-auto">
                                    ...
                                    <div class="mt-4 text-center" id="soal">
                                        ...
                                        if (isset($folder)) {
                                            if (isset($soal)) {
                                                foreach ($soal as $f) :
                                                    if ($f['mulai'] <= date('H:i') && $f['akhir'] >= date('H:i')) {
                                        ?>
                                        ...
                                        <?php
                                                    } elseif ($f['akhir'] < date('H:i')) {
                                                        $selesai = $f['akhir'];
                                                        $date = $f['tanggal'];
                                                        $query = "UPDATE soal SET status = 'nonaktif' WHERE tanggal = '$date' AND akhir = '$selesai'";
                                                        $this->db->query($query);
                                                    }
                                                endforeach;
                                            } else {
                                                echo '<h4>Soal Tidak Ditemukan<h4>';
                                            }
                                        } else {
                                            echo '<h4>Folder Tidak Ditemukan<h4>';
                                        } ?>
                                    </div>
                                </div>
                            </div>
