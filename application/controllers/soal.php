...
class soal extends CI_Controller
{
    ...
    public function store_soal()
    {
        ...
        $this->form_validation->set_rules('mulai', 'Jam Mulai Ujian', 'trim|required');
        $this->form_validation->set_rules('akhir', 'Jam Akhir Ujian', 'trim|required');
    ...
    public function update_soal($kode)
    {
        ...
        $this->form_validation->set_rules('tanggal', 'Tanggal Ujian', 'trim|required');
        $this->form_validation->set_rules('mulai', 'Jam Mulai Ujian', 'trim|required');
        $this->form_validation->set_rules('akhir', 'Jam Mulai Ujian', 'trim|required');
        $this->form_validation->set_rules('status', 'Status Soal', 'trim|required');
