...
class token extends CI_Controller
{
    ...
    public function store_token()
    {
        ...
        $this->form_validation->set_rules('tanggal', 'Tanggal Token', 'trim|required');
        $this->form_validation->set_rules('mulai', 'Waktu Mulai', 'trim|required');
        $this->form_validation->set_rules('akhir', 'Waktu Akhir', 'trim|required');
        $this->form_validation->set_rules('status', 'Status Token', 'trim|required');
