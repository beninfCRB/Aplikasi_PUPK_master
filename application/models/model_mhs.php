...
class Model_mhs extends CI_Model
{
	...
	{
		$query = "SELECT * FROM mahasiswa INNER JOIN semester ON smt_id = id_smt INNER JOIN kelas ON kelas_id = id_kls INNER JOIN sesi ON sesi_id = id_sesi ORDER BY mahasiswa.TimeStamp DESC";
